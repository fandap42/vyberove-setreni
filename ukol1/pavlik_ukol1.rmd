...
for (n in ns) {
    ...
    rel_df <- rbind(rel_df, data.frame(n = n, k=ks, rel = ks / n, prob = probs, cdf = cdfv)) 
}

kable(rel_df[rel_df$n == 3, c("k",'rel','prob','cdf')], digits = 6)
kable(rel_df[rel_df$n == 4, c("k",'rel','prob','cdf')], digits = 6)
kable(rel_df[rel_df$n == 5, c("k",'rel','prob','cdf')], digits = 6) 
```
