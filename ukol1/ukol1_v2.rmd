...
## 2) Pro rozsahy výběru n=3,4,5 vypočtěte střední hodnotu a rozptyl výběrové relativní četnosti. Jsou výběrové průměry nestranné odhady populační relativní četnosti? Vypotěte vychýlení (bias) pro tyto odhady.
```{r}
