...
```{r mean-var-bias}
## Convert stats_means (list) to a tidy data frame and show as table
...
# Print as a neat table in the knit output
knitr::kable(df_stats_means, digits = 4, caption = "Střední hodnota, rozptyl a bias výběrového průměru")

# Zhodnocení nestrannosti: bias blízko 0 -> nestranný (tabulka bias)
