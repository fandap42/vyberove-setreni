...
sum(odh.struktury2)
### radkove soucty
SampRadek=rowSums(odh.struktury2)
# porovnani radkovych soucty
PopRadek-SampRadek
### vypocet prvni iterace

odh.struktury3=odh.struktury2*rep(t(PopRadek/SampRadek),J)
odh.struktury3
### kontrola radkovych souctu
rowSums(odh.struktury3)
rowSums(odh.struktury3)-PopRadek
### kontrola sloupcovych souctu
colSums(odh.struktury3)
colSums(odh.struktury3)-PopSloupec
sum(colSums(odh.struktury3))
### prevazene odhady uhrnu populacni sumy
sum(odh.struktury3)
sum(odh.struktury2)
...
sum(odh.struktury3)
### sloupcove soucty
SampSloupec=colSums(odh.struktury3)
SampSloupec
sum(SampSloupec)
# porovnani sloupcovych soucty
PopSloupec-SampSloupec
...
odh.struktury4=odh.struktury3*matrix(rep((PopSloupec/SampSloupec),I),nrow=I,byrow=TRUE)
odh.struktury4
sum(odh.struktury4)
### kontrola radkovych souctu

sum(rowSums(odh.struktury4)-PopRadek)
rowSums(odh.struktury4)-PopRadek
### kontrola sloupcovych souctu
colSums(odh.struktury4)
sum(colSums(odh.struktury4)-PopSloupec)

colSums(odh.struktury4)-PopSloupec
### prevazene odhady uhrnu populacni sumy
sum(odh.struktury4)
sum(odh.struktury3)
