...
\end{equation}
Tento výsledek, formálně dokázaný např. v \cite{Serfling1980} nebo \cite{VanDerVaart1998}, ukazuje fundamentální závislost přesnosti odhadu na lokální hustotě pravděpodobnosti. Je-li hustota $f(q_p)$ malá (např. v chvostech rozdělení), stává se jmenovatel velmi malým, což vede k "explozi" rozptylu odhadu.
