...
\end{equation}
Tento metoda je odvozena v \parencite{VanDerVaart1998}, ukazuje závislost přesnosti odhadu na pravděpodobnostní funkci. Je-li hustota $f(q_p)$ malá (např. v chvostech rozdělení), stává se jmenovatel velmi malým, což vede k velkým odhadům rozptylu.
Tento výsledek je standardní větou v asymptotické statistice \parencite{VanDerVaart1998}. Ukazuje, že přesnost odhadu kvantilu závisí nepřímo úměrně hodnotě hustoty v daném bodě. V oblastech, kde je hustota nízká (chvosty rozdělení), je rozptyl odhadu kvantilu vysoký.
