...
Jako podkladová data používáme log-normální rozdělení $LN(\mu, \sigma^2)$ s parametry $\mu=0$ a $\sigma \in {0,5; 1; 1,5}$.
Generujeme náhodné výběry o rozsahu $n \in \{30, 100, 500, 1000\}$ pro simulaci malých, středních a velkých datových souborů.
...
\subsection{Teoretická delta metoda}
...
Tato metoda slouží jako ideální v praxi nedosažitelný benchmark, protože v reálných situacích povětšinou neznáme skutečné rozdělení dat.

\subsection{Praktický delta metoda}
